...
Script Version: v1.1.5 Explorer
...
function start_system() {
    ...
    let html_set = '<top alt="topbar">Enter Form JSON URL: <input placeholder="Enter URL!" class="topbar_loaded_a" type="text" id="explore_button_input_sys">    <button type="button" class="topbar_loaded_b" id="exploreButton" onclick="explore()">Explore!</button></top>\n' + '<div id="main_menu">\n' +
...
(function () {
    window.addEventListener("load", function () {
        loadFormJSONfromURL("https://forms.efaz.dev/example.json");
    });
})();