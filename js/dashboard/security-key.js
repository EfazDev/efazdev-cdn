...
EfazForms.on_form_loaded = async function (_) {
    var data = `<p class="footer">Setting up your 2FA means you agree to Efaz"s <a href="https://efaz.dev/tos">Terms of Service</a> and <a href="https://efaz.dev/privacy">Privacy Policy</a>.</p>`;
...
async function main() {
    ...
    if (data.success == true) {
        await EfazForms.loadFormJSONfromURLByAsync("https://db.efaz.dev/forms/dev.efaz.forms.security-key-setup");
    } else {
