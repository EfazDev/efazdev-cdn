...
(function () { // Prevent changes made using the Inspect console.
    ...
    try {
        ...
        function getChromeURL(resource) {
            try {
                ...
                if (chrome.runtime.getManifest()["homepage_url"] == "https://www.efaz.dev/roblox-extension") {
                    ...
                    return chrome.runtime.getURL("dev.efaz.marketplace_renamer" + "/" + resource);
                } else {
                ...
                if (tab.href) {
                    ...
                    if (tab.hostname == "www.roblox.com") {
                        ...
                        function blacklisted(header, attribute) {
                            ...
                            if (header.getAttribute("ng-renamed1") == "true") { return true; }
        ...
        console.warn(`Failed to insert rename into this tab. Error Message: ${err.stack}`);
    }
}());