                    ...
                    if (urlObj.hostname == "www.roblox.com") {
                        ...
                        if (stored_css) {
                            ...
                            if (remoteStyles == true) {
                                ...
                                fetch(chrome.runtime.getURL("remove-builder-font/chromeExtension/change_font.css")).then(res => { return res.text() }).then(fetched => {
                                    stored_css = fetched
                                    overwriteResourcesUrl(fetched, trusted_source, 1, oldFontOnOtherSub).then(a => {
                                        injectCSS(a)
                                    })
                        ...
                        if (devForum == true) {
                            ...
                            if (stored_devforum_css) {
                                ...
                                if (remoteStyles == true) {
                                    ...
                                    fetch(chrome.runtime.getURL("remove-builder-font/chromeExtension/devforum_font.css")).then(res => { return res.text() }).then(fetched => {
                                        stored_devforum_css = fetched
                                        overwriteResourcesUrl(fetched, trusted_source, 2, oldFontOnOtherSub).then(a => {
                                            injectCSS(a)
                                        })
                        ...
                        if (overwriteCreateDashboard == true) {
                            ...
                            if (stored_creator_dashboard_css) {
                                ...
                                if (remoteStyles == true) {
                                    ...
                                    fetch(chrome.runtime.getURL("remove-builder-font/chromeExtension/creator_dashboard.css")).then(res => { return res.text() }).then(fetched => {
                                        stored_creator_dashboard_css = fetched
                                        overwriteResourcesUrl(fetched, trusted_source, 3, oldFontOnOtherSub).then(a => {
                                            injectCSS(a)
                                        })
                        ...
                        if (otherSub == true && !(urlObj.hostname.includes("create.roblox.com"))) {
                            ...
                            if (stored_creator_dashboard_css) {
                                ...
                                if (remoteStyles == true) {
                                    ...
                                    fetch(chrome.runtime.getURL("remove-builder-font/chromeExtension/global_font.css")).then(res => { return res.text() }).then(fetched => {
                                        stored_creator_dashboard_css = fetched
                                        overwriteResourcesUrl(fetched, trusted_source, 4, oldFontOnOtherSub).then(a => {
                                            injectCSS(a)
                                        })
